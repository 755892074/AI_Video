"""Director3D v2: 录制 10s walkscene（大步伐版），验证 H3 域迁移走路幅度
- 与 v1 完全相同的相机/场景/物体布局
- 仅走路动画参数加大：leg hip 0.7→1.1, knee 0.9→1.3, arm shoulder 0.6→0.95, bounce 0.05→0.12, 步频 1.8→1.6Hz
