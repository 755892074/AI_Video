# -*- coding: utf-8 -*-
"""监控 v3 6 镜生成并下载。每 30s 查一次, 全部完成后退出。"""
import json
import os
import time
...
OUT_DIR = r"c:/Users/Lionel/WorkBuddy/Claw/ai_video_results/zhou_woyangni_v3"
...
def main() -> None:
    ...
    while pending:
        ...
        if running:
            ...
            print(f"⏳ 剩余 {running} 镜, 已运行 {elapsed//60}min", flush=True)
